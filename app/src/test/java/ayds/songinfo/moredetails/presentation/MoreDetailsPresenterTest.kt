...
class OtherInfoPresenterTest {
    ...
    private val otherInfoPresenter: MoreDetailsPresenter =
        MoreDetailsPresenterImpl(otherInfoRepository, artistBiographyDescriptionHelper)
    ...
    fun `getArtistInfo should return artist biography ui state`() {
        ...
        every { otherInfoRepository.getArtistInfoFromRepository("artistName") } returns artistBiography
